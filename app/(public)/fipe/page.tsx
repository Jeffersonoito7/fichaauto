...
export default function FipeBuscaPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Header verde */}
      <div className="bg-green-600 px-6 pt-14 pb-8">
        ...
        <p className="text-green-100 text-sm">Digite a placa e veja o valor de mercado</p>
      </div>
      ...
      <div className="px-4 -mt-4">
          ...
          <form onSubmit={buscar} className="space-y-3">
            <div className="relative">
              <input
                ...
                maxLength={7}
                className="w-full border border-gray-200 rounded-xl px-4 py-3 pr-12 text-base font-mono tracking-widest uppercase focus:outline-none focus:ring-2 focus:ring-green-500"
              />
        ...
        <div className="mt-6 bg-green-50 rounded-xl p-4 text-center">
          <p className="text-xs text-green-700 font-medium">Quer o relatório completo?</p>
          <p className="text-xs text-green-500 mt-1">Gravame, leilão, roubo, RENAJUD e muito mais</p>
